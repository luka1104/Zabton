...
import { Box, Center, Button, Icon, Modal, ModalOverlay, ModalContent, ModalBody, Text, Image, useDisclosure, Link } from '@chakra-ui/react'
    ...
    <>
      <Box ref={finalRef}>
        ...
        <Center gap='2'>
          ...
          <Link href={`http://twitter.com/share?url=https://zabton.vercel.app/validate?id=${selectedTheme.id}`}>
